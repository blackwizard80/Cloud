...
function setupChat() {
  ...
  window.oncontextmenu = function(event) {
      // Prevent default menu only on chat bubbles
  ...
  messagesDiv.addEventListener("touchstart", handleLongPressStart, {passive: false}); // passive: false to allow preventDefault
  ...
  function handleLongPressStart(e) {
      ...
      pressTimer = setTimeout(() => {
          ...
          // Better positioning logic using Viewport coordinates
          const rect = messageTarget.getBoundingClientRect();
          
          reactionPopup.style.position = "fixed"; // Fixed ensures it stays put
